...
router.use(createModuleBodyContract(['addressLine1', 'city', 'contactEmail', 'contactPhone', 'country', 'document_type_id', 'entity_type', 'fullName', 'inventoryCostMethod', 'locked', 'method', 'settings']));
